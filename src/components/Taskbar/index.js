  ...
  return (
    ...
    >
      <div className="taskbar-icons">
        <div
          className="task task-terminal"
          id="terminal"
          onClick={(event) => handleClick(event, terminal)}
        >
          <span className="task-indicator terminal-indicator" />
          <img src={TerminalImage} alt="" className="task-icon" />
        </div>
        <div
          className="task task-folder"
          id="folder"
