...
export const WORDING_EN = {
  ...
  mail_mailto_text: 'Send an email from your email software',
  ...
  presentation_text:
    "Welcome to my portfolio.<br>I'm Tony Herbet Le Faucheur, 36 years old, I am an Application Designer and Developer specialized in React.<br>I am available immediately and preferably looking for a full remote position or at least with several days remote.<br>In fact, I hold a disabled worker recognition status (RQTH), so I cannot travel long distances. I live in Colombes, 92700, and am vehicled.<br><br>You can contact me directly via the email option on this site or at this address if you wish : <a href='mailto:herbet.le.faucheur.tony@gmail.com' target='_blank' rel='noopener noreferrer'>herbet.le.faucheur.tony@gmail.com</a>.<br>And if you really like adventure and games of chance you can try to contact me on <a href='https://www.linkedin.com/in/tony-herbet-le-faucheur' target='_blank' rel='noopener noreferrer'>linkedIn</a> and I will answer you when one of my biannual connections.<br>Some of my projects are available on my github : <a href='https://github.com/Tony-Herbet' target='_blank' rel='noopener noreferrer'>https: //github.com/Tony-Herbet</a>.<br><br>For the slightly less serious personal informations : I'm a fan of video games, manga, series and I waste an unspeakable amount of time on YouTube.",
  ...
  dnd_text: {
    ...
    team: 'Alone',
    description:
      'After my first training for which I chose the React specialization, I wanted to discover similar frameworks. I started by following the beginning of a Vue.js course on Udemy. When I had the feeling of Having understood the differences, at a fundamental level of course, I embarked on a small project. With the sole support of documentation, in order to experiment by coding.<br>Having only seen the basics, I decided to do something very simple with a form and some data processing.<br>Playing Dungeons and Dragons 5e at that time and being a fan of theorycrafting, I used to create different characters. I chose to make a damage calculation tool in order to automate some of the math required to compare these characters.',
  },
  canvas_text: {
  ...
  lorenzo_text: {
    ...
    team: '3 people, we all worked on the Full-Stack',
    description:
  ...
  apptitude_text: {
    ...
    role: 'Front-End Developer',
    date: 'From December 2024 to January 2025',
    type: '2 freelance missions',
    team: 'Alone',
    tech: 'React, Next.js, Tailwind CSS, AWS',
    description:
      "As part of the first mission, I took over the Apptitude project, a fitness website, and made modifications based on the client's requests. I had to update the CSS and adjust certain features that were no longer supported or had been modified, such as payment management. I then deployed the application on the AWS platform. For the second mission, the objective was to industrialize the application to quickly create fitness, yoga, and pilates versions for other brands. To achieve this, I dynamized the theme, catalog, and languages, ensuring these elements were automatically managed through a simple configuration file. I then created a detailed guide explaining how to set up a configuration and integrate it into the deployment process.",
  },
  cv_name: 'Résumé.pdf',
};
